...
FUNCTION(ADD_TESTS)
    ...
    foreach(SOURCE_FILE_NAME  ${TEST_SRCS})
        ...
        #Read the current source file, i.e. some test/WhatEverTest.cpp
        file(READ "${SOURCE_FILE_NAME}" SOURCE_FILE_CONTENTS)
        #Get all test functions of the form BOOST_FIXTURE_TEST_CASE(NAME, FIXTURE) and BOOST_AUTO_TEST_CASE, but only the part BOOST_(FIXTURE/AUTO)_TEST_CASE(NAME
